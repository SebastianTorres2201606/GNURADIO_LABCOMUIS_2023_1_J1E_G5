...
class CalculoPotenciaComunicaciones(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, l_vect=1024):
        ...
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_float*1, l_vect)
        ...
        self.ModulosEfren_SumaVector_1 = ModulosEfren.SumaVector(l_vect)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.ModulosEfren_SumaVector_1, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_stream_to_vector_1, 0))
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.ModulosEfren_SumaVector_1, 0))
