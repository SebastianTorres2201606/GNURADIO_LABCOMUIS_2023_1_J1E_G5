...
# Title: Calculo_Potencia _J1EG5
# Author: Efren_Acevedo
# Copyright: Efren_Acevedo
...
class calculoPotenciaJ1E(gr.hier_block2, Qt.QWidget):
    def __init__(self, l_vect=1024):
        gr.hier_block2.__init__(
            self, "Calculo_Potencia _J1EG5",
