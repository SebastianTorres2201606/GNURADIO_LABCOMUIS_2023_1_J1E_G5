...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fs_win = RangeWidget(self._fs_range, self.set_fs, "Frecuencia Pulsos", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._D3_win = RangeWidget(self._D3_range, self.set_D3, "Retardo3", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._D3_win)
        self._D2_range = Range(0, 100, 1, 0, 200)
        self._D2_win = RangeWidget(self._D2_range, self.set_D2, "Retardo2", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._Am_range = Range(0, 10, 100, 1, 200)
        self._Am_win = RangeWidget(self._Am_range, self.set_Am, "Amplitud mensaje", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self.ModulacionPAM_0_1_1 = ModulacionPAM(
            D=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        self.connect((self.ModulacionPAM_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.ModulacionPAM_0_1, 0), (self.blocks_delay_0, 0))
        self.connect((self.ModulacionPAM_0_1_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.ModulacionPAM_0_1_1, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulacionPAM_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.ModulacionPAM_0_1_1, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.ModulacionPAM_0_1, 0))
        self.connect((self.analog_sig_source_x_0_2, 0), (self.ModulacionPAM_0_1_0, 0))
        ...
        self.connect((self.blocks_delay_0_1, 0), (self.qtgui_time_sink_x_1, 3))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ModulacionPAM_0_1_1.set_samp_rate(self.samp_rate)
    ...
    def set_fs(self, fs):
        ...
        self.ModulacionPAM_0_1_1.set_fs(self.fs)
    ...
    def set_D(self, D):
        ...
        self.ModulacionPAM_0_1_1.set_D(self.D)
