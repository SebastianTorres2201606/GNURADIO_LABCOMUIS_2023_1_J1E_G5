...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.Lab3_0, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.Lab3_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Lab3_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Lab3_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.PruebaPotencia_0, 0))
