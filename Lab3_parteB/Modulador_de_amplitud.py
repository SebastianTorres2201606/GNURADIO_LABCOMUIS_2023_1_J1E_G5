...
from PruebaPotencia import PruebaPotencia  # grc-generated hier_block
...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(1000, 50e6, 10000, 1.5625e6, 200)
        ...
        self._Ka_range = Range(0, 20, 0.01, 1, 200)
        ...
        self._K_range = Range(0, 2, 1, 0.5, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Desktop/2201606/LabCom_J1E_G5/Lab1_ParteB/punto5/rebelion_joearroyo.wav', True)
        self.audio_sink_0 = audio.sink(48000, '', True)
        self.PruebaPotencia_0 = PruebaPotencia(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.PruebaPotencia_0)
        ...
        # Connections
        ##################################################
        self.connect((self.Envolvente_Compleja_0, 0), (self.qtgui_freq_sink_x_1, 0))
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.PruebaPotencia_0, 0))
    ...
    def set_K(self, K):
        self.K = K
        self.Envolvente_Compleja_0.set_Ac(self.K)
    ...
    def set_B(self, B):
        self.B = B
        self.Envolvente_Compleja_0.set_Ka(self.B)
