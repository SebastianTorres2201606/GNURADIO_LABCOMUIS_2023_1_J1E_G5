...
class lab1B(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._bw_range = Range(10, 500000, 10, 1500, 200)
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/uis-e3t/Escritorio/LabCom_J1E_G5/Lab1_ParteB/punto5/rebelion_joearroyo.wav', True)
